...
if(isset($_POST['submit'])){
	...
	$status = $_POST['status'];
  	...
  	$insert_data = "INSERT INTO admin_data(u_card, u_f_name, u_l_name, u_gender, u_email, u_phone, course_name,status)
	 VALUES ('$u_card','$u_f_name','$u_l_name','$u_gender','$u_email','$u_phone','$u_course_name',$status)";
...
<body>
<h1 style="color: green;" >Admin Panel</h2>
...
?>
  ...
  <i class="fa fa-plus"></i> Add New Student
		...
		<thead>
        	...
        	$get_data = "SELECT * FROM admin_data order by 1 desc";
    ...
    <tr>
        ...
        <td class='text-center'>
            <button onclick=\"changeStatus('$status', this)\">$status</button>
        </td>
    </tr>
";
...
echo "
<script>
	function changeStatus(currentStatus,buttonElement) {
		...
		buttonElement.innerHTML = currentStatus;
	}
</script>
";
